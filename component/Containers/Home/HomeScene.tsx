  ...
  <body>
    ...
    <main>
      ...
      <section class="section-tours">
        ...
        <div class="row" id="section-tours">
          ...
          <div class="story">
            <figure class="story__shape">
              <img
                ...
                class="story__img"
              />
              <figcaption class="story__caption">Alisa Hayden</figcaption>
            </figure>
            <div class="story__text">
              <h3 class="u-margin-bottom-small heading-tertiary">
          ...
          <div class="story">
            <figure class="story__shape">
              <img
                ...
                class="story__img"
              />
              <figcaption class="story__caption">David Wilson</figcaption>
            </figure>
            <div class="story__text">
              <h3 class="u-margin-bottom-small heading-tertiary">
      ...
      <div class="row">
        ...
        <div class="col-1-of-2">
          <p class="footer__copyright">
            Built by
            <a href="#" class="footer__link footer__link__author-name">
              Denver
            </a>
      ...
      <div class="popup__content">
        ...
        <div class="popup__right">
          ...
          <p class="popup__text">
            ...
            consectetur cumque, eveniet nihil harum numquam suscipit tempore
            asperiores sunt vero ducimus laboriosam totam blanditiis
            exercitationem aperiam corporis. Atque ex animi veniam beatae iusto,
            rem delectus. Lorem ipsum, dolor sit amet consectetur adipisicing
            elit. Quibusdam nemo nostrum aspernatur? Libero ratione eligendi
            aspernatur dignissimos iste eius molestiae quas voluptate, corporis
            adipisci possimus, incidunt deserunt dolorum fuga voluptates
            deleniti dolores necessitatibus! Sit, aperiam, ullam explicabo
            soluta officiis fugiat expedita voluptates quas velit maiores esse
            dolores voluptatibus quibusdam alias! Lorem ipsum dolor sit amet,
            consectetur adipisicing elit. Voluptatibus possimus itaque quas
            distinctio cum. Vitae porro quidem eveniet beatae atque vel et
            voluptatibus
          </p>
